...
# 입력 파일 경로
base_path = os.getenv('COSYVOICE_PATH', '/shared/CosyVoice')
input_csv_path = os.path.join(base_path, 'dataset/Asan-AMC-Healthinfo.csv')
kson_csv_path = os.path.join(base_path, 'results/tts_data.csv')
output_dir = os.path.join(base_path, 'results/Asan/wav')
output_csv_path = os.path.join(base_path, 'results/Asan/manifest.csv')
