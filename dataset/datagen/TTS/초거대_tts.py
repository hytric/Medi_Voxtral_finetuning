...
# 입력 파일 경로
input_path = 'CosyVoice/dataset/AI_Hub_medQA.json'
kson_csv_path = "CosyVoice/results/tts_data.csv"
output_dir = "CosyVoice/results/초거대/wav"
output_csv_path = "CosyVoice/results/초거대/manifest.csv"
